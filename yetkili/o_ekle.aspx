<%@ Page Title="" Language="C#" MasterPageFile="~/yetkili/yetkili_panel.Master" AutoEventWireup="true" CodeBehind="o_ekle.aspx.cs" Inherits="BLibraryPortal.yetkili.okuyucu_ekle" %>
		...
		<div class="pd-ltr-20">
			...
			<div class="page-header">
						...
						<div class="title">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active"><a href="o_ekle.aspx">Okuyucu Ekle</a></li>
								</ol>
							</nav>				
					</div>					
				</div>
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Okuyucu ekleme ekranı</h4>
					...
					<form>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6 col-md-5">								
								<asp:TextBox ID="TextBox1" runat="server" class="form-control" type="text" placeholder="11111111111" maxlength="11"></asp:TextBox>
							</div>
				...
				<asp:Panel ID="Panel1" runat="server" Visible="False">
						...
						<div class="form-group row">
							<div class="col-sm-6 col-md-5">	
								<asp:Button ID="Button1" runat="server" Text="Kaydet" class="btn btn-primary" OnClick="Button1_Click"/>
